...
#define NUM_S LT(_NUMPAD, KC_S)
#define NUM_L LT(_NUMPAD,KC_L)
...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_UNDER_M] = ACTION_TAP_DANCE_DOUBLE(KC_M, KC_UNDS),
    [TD_DASH_V] = ACTION_TAP_DANCE_DOUBLE(KC_V, KC_MINS),
};

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_split_3x5_3( 
        KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,             KC_Y,    KC_U,    KC_I,    KC_O,   KC_P,  
        CTRL_A,  NUM_S,    ALT_D,    SHFT_F,    KC_G,         KC_H,    SHFT_J,    ALT_K, NUM_L,   KC_CTSC, 
        KC_Z,  KC_X,    KC_C,    TD(TD_DASH_V), KC_B,               KC_N,    TD(TD_UNDER_M),    KC_COMM, KC_DOT, KC_SLASH, 
                  KC_LGUI, TAB_LOWER, RAISE_SPC,                RASE_BACK, LOWER_ENT, ALT_TAB
                ),
  ...
  [_LOWER] = LAYOUT_split_3x5_3( 
    ...
    [_NUMPAD] = LAYOUT_split_3x5_3(
          ...
          XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,            XXXXXXX, KC_1, KC_2, KC_3, XXXXXXX,
                            KC_GAMER, KC_FFXIV, KC_MS_BTN1,               KC_0, _______, _______
    ),
    [_GAMING] = LAYOUT_split_3x5_3(
          XXXXXXX, XXXXXXX, KC_W, KC_R, XXXXXXX,             XXXXXXX, KC_7, KC_8, KC_9, XXXXXXX,
          ...
          XXXXXXX, XXXXXXX, XXXXXXX, KC_V, XXXXXXX,            XXXXXXX, KC_1, KC_2, KC_3, XXXXXXX,
                            _______, KC_TAB, KC_SPC,               KC_0, _______, _______
    ),
    [_FFXIV] = LAYOUT_split_3x5_3(
          XXXXXXX, KC_Q, KC_W, KC_E, XXXXXXX,             XXXXXXX, KC_7, KC_8, KC_9, XXXXXXX,
          KC_LSFT, KC_A, KC_S, KC_D, KC_G,                   XXXXXXX, KC_4, KC_5, KC_6, XXXXXXX,
          XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,            XXXXXXX, KC_1, KC_2, KC_3, XXXXXXX,
                            _______, KC_TAB, KC_SPC,               KC_0, _______, _______
    )
